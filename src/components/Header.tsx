    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-[#0a0a0a]/70 border-b border-white/10">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6">
        <div className="flex items-center gap-3 py-3">
          ...
          <img src="/brightblox.png" alt="Brightblox" className="h-9 sm:h-11 w-auto shrink-0" />
        </div>
        <nav className="hidden items-center gap-6 md:flex py-3">
        ...
        <div className="hidden items-center gap-3 md:flex py-3  ">
