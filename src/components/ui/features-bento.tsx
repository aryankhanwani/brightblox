...
import { Shield, Users, Zap, Target, TrendingUp, Globe } from 'lucide-react'
            ...
            <div className="mx-auto max-w-7xl px-6 py-16">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        {/* Main Feature Card - Customizable */}
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-white/[0.03] backdrop-blur-sm border-white/10">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    <svg className="text-[#22d3ee] absolute inset-0 size-full" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <p className="mt-2 text-center text-sm text-white/70">Tailored Web3 career paths for every background</p>
                            </CardContent>
                        </Card>

                        {/* Secure by Default */}
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-white/[0.03] backdrop-blur-sm border-white/10">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border-white/5">
                                    <Shield className="m-auto h-fit w-24 text-[#10b981]" strokeWidth={1} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium text-white transition">Secure by default</h2>
                                    <p className="text-white/70">Learn from verified industry experts with proven track records in Web3.</p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-white/[0.03] backdrop-blur-sm border-white/10">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="text-white/50 w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="386" height="123" rx="10" fill="currentColor" opacity="0.1"/>
                                        <g clipPath="url(#clip0_0_106)">
                                            <circle className="text-white/30" cx="29" cy="29" r="15" fill="currentColor" />
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                                <stop className="text-[#22d3ee]/15" stopColor="currentColor" />
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    ...
                                    <p className="text-white/70">Accelerate your Web3 career with our proven 90-day transformation program.</p>
                                </div>
                            </CardContent>
                        </Card>

                        {/* Target Achievement */}
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-white/[0.03] backdrop-blur-sm border-white/10">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border-white/5">
                                        <Target className="m-auto size-5 text-[#f59e0b]" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-white transition">Targeted Success</h2>
                                        <p className="text-white/70">Precision-guided career paths with measurable outcomes and clear milestones.</p>
                                    </div>
                                </div>
                                    ...
                                    <svg className="w-full sm:w-[150%]" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_0_705" x1="0.85108" y1="0.947876" x2="0.85108" y2="230.114" gradientUnits="userSpaceOnUse">
                                                <stop className="text-[#f59e0b]/15" stopColor="currentColor" />
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-white/[0.03] backdrop-blur-sm border-white/10">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border-white/5">
                                        <Users className="m-auto size-6 text-[#8b5cf6]" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-white transition">Global Web3 Network</h2>
                                        <p className="text-white/70">Connect with 200+ successful Web3 professionals and industry leaders worldwide.</p>
                                    </div>
                                </div>
                                <div className="before:bg-white/10 relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-white/10 bg-white/[0.03] px-2 py-1 text-xs text-white/70 shadow-sm">Ethereum</span>
                                            <div className="ring-[#0c0c0c] size-7 ring-4">
                                                <div className="size-full rounded-full bg-gradient-to-r from-[#22d3ee] to-[#10b981]"></div>
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-[#0c0c0c] size-8 ring-4">
                                                <div className="size-full rounded-full bg-gradient-to-r from-[#8b5cf6] to-[#f59e0b]"></div>
                                            </div>
                                            <span className="block h-fit rounded border border-white/10 bg-white/[0.03] px-2 py-1 text-xs text-white/70 shadow-sm">Polygon</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-white/10 bg-white/[0.03] px-2 py-1 text-xs text-white/70 shadow-sm">Solana</span>
                                            <div className="ring-[#0c0c0c] size-7 ring-4">
                                                <div className="size-full rounded-full bg-gradient-to-r from-[#ef4444] to-[#22d3ee]"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
